...
//
//
// $Id: ExN02PhysicsList.cc,v 1.1 2014/01/22 15:35:03 veni Exp $
//
...
void ExN02PhysicsList::ConstructEM()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      ph->RegisterProcess(new G4SynchrotronRadiation,particle); //Raggi     
      // ph->RegisterProcess(new G4ElectronNuclearProcess,particle); //photonuclear positron Raggi
      // ph->RegisterProcess(new G4Cerenkov,particle); //Cherenkov for electrons Raggi
    } else if (particleName == "e+") {
      //positron
      ph->RegisterProcess(new G4eMultipleScattering, particle);
      ph->RegisterProcess(new G4eIonisation,         particle);
      ...
      ph->RegisterProcess(new G4SynchrotronRadiation,particle); //Raggi
      //ph->RegisterProcess(new G4PositronNuclearProcess,Particle); //photonuclear positron Raggi
      //    ph->RegisterProcess(new G4Cerenkov,particle); //Cherenkov for positrons Raggi
      ...
      //      ph->RegisterProcess(new G4Cerenkov,particle); //Cherenkov for Muons Raggi
