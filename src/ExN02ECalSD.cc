...
//
//
// $Id: ExN02ECalSD.cc,v 1.1 2014/01/22 15:35:03 veni Exp $
//
...
ExN02ECalSD::ExN02ECalSD(G4String name)
...
ExN02ECalSD::~ExN02ECalSD(){ }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void ExN02ECalSD::Initialize(G4HCofThisEvent* HCE)
{
  ECalCollection = new ExN02ECalHitsCollection
...
G4bool ExN02ECalSD::ProcessHits(G4Step* aStep,G4TouchableHistory*)
{
  ...
  ExN02ECalHit* newHit = new ExN02ECalHit();
  ...
  //  newHit -> SetTime (aStep->GetPostStepPoint()->GetPosition());
...
void ExN02ECalSD::EndOfEvent(G4HCofThisEvent*)
{
  if (verboseLevel>0) { 
