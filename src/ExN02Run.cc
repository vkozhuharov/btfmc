...
//
//
// $Id: ExN02Run.cc,v 1.1 2014/01/22 15:35:03 veni Exp $
//
...
void ExN02Run::RecordEvent(const G4Event* evt)
{
...
G4double ExN02Run::GetTotal(const G4THitsMap<G4double> &map) const
{
  G4double tot = 0.;
...
G4double ExN02Run::FindMinimum(const G4THitsMap<G4double> &map) const
{
